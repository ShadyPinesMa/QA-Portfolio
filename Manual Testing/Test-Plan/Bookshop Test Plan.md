...
## **2\. Scope of testing** {#2.-scope-of-testing}
	...
	The scope of this testing project is the modules of “Bookshop.org” as defined below.

### 2.1 In-scope {#2.1-in-scope}

	Functional manual testing will be conducted on the following modules:
...
### 2.2 Out of scope {#2.2-out-of-scope}
	...
	Automated functional testing and all forms of non-functional testing are out of scope for this testing project. Some examples of non-functional testing are listed below:
...
| Activity | Dates |
| ----- | ----- |
| Test Planning | November 3, 2025 \- November 5, 2025 |
| Test Case Design | November 6, 2025 \- November 11, 2025 |
| Test Environment Setup | November 12, 2025 |
| Test Execution | November 12, 2025 \- November 13, 2025 |
| Defect Resolution | November 14, 2025 \- November 15, 2025 |
| Test Closure | November 16, 2025 |
...
## **7\. Test Data** {#7.-test-data}
	...
	The testing team will be developing test data as part of the testing procedure. Existing data from the live website will be used depending on the test cases.
...
## **8\. Stakeholders \- roles and responsibilities** {#8.-stakeholders---roles-and-responsibilities}
	...
	Developers: responsible for developing the application, conducting unit testing, fixing defects and assigning defects to testing team  
...
| TBD | Developer | Develop the application, conduct unit testing, fix defects, assign defects to testing team |
