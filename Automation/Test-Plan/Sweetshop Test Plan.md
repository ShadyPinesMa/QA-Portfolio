...
Java Selenium Web Automation Project  
Sweetshop.co

**TEST PLAN**

Version \- Draft (05/11/2026)
...
| Activity | Dates |
| ----- | ----- |
| Test Planning | April 28, 2026 \- May 2, 2026 |
| Test Case Design | May 4, 2026 \- May 5, 2026 |
| Test Environment Setup | May 6, 2026 \- May 9, 2026 |
| Test Execution | May 10, 2026 \- May 11, 2026 |
| Defect Resolution | May 11, 2026 \- May 12, 2026 |
| Test Closure | May 13, 2026 |
...
* IntelliJ IDEA: used to write the page object models (POMs), write automated tests, and carry out the tests  
* Selenium Web Driver: browser automation tool used for testing purposes  
* TestNG: testing framework used  
...
## **7\. Test Data** {#7.-test-data}
	...
	The testing team will be developing test data as part of the testing procedure. Existing data from the live website will be used depending on the test cases. For the specific test data used, please view the project (SweetShopTest) in IntelliJ IDEA. It contains data added for specific tests and a CSV file used for user flow verification
